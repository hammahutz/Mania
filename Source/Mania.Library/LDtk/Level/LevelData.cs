...
public class LevelData
{
    ...
    public LevelBackgroundPositionData BgPos { get; set; }
    ...
    public NeighbourLevelData[] Neighbours { get; set; }
    ...
    public BgPosData? LevelBgPos { get; set; }
    ...
    public FieldInstanceData[] FieldInstances { get; set; }
    ...
    public LayerInstanceData[] LayerInstances { get; set; }
