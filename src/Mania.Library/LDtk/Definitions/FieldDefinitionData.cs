...
public class FieldDefinitionData
{
    ...
    public AllowedRefsData AllowedRefs { get; set; }
    ...
    public EditorDisplayModeData EditorDisplayMode { get; set; }

    /// <summary>
    /// Possible values: `Above`, `Center`, `Beneath`
    /// </summary>
    [JsonPropertyName("editorDisplayPos")]
    public EditorDisplayPosData EditorDisplayPos { get; set; }
    ...
    public EditorLinkStyleData EditorLinkStyle { get; set; }
    ...
    public TextLanguageModeData? TextLanguageMode { get; set; }
    ...
    /// <summary>
    /// public enum representing the possible field types. Possible values: F_Int, F_Float,
